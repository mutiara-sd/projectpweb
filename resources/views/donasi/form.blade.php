        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto px-8 py-10 bg-white rounded-xl shadow-2xl">
                ...
                <form action="{{ route('donasi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label class="block font-semibold mb-2 text-gray-800">Alamat</label>
                    ...
                    <div>
                        <label class="block font-semibold mb-2 text-gray-800">Status Halal</label>
                    ...
                    <div>
                        <label class="block font-semibold mb-2 text-gray-800">Foto Makanan</label>
                        <input type="file" name="gambar" accept="image/*" class="w-full p-3 border rounded bg-gray-100" required>
                    </div>

                    <button type="submit" class="w-full bg-blue-800 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-200">
                        Tambah Donasi
                    </button>
                </form>
            </div>
